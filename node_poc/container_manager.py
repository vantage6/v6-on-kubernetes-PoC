...
class ContainerManager:
    ...
    def __get_job_pod_logs(self,job_id:str,namespace="v6-jobs") -> str:
        """"
        ...
        for job_pod in job_pods_list.items:
            ...
            pods_tty_output = pods_tty_output.join(self.core_api.read_namespaced_pod_log(job_pod.metadata.name, "v6-jobs"))

        return pods_tty_output
